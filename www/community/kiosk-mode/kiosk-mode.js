...
Array.isArray(e)||(r=function(e,t){if(e){if("string"==typeof e)return c(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Map"===(
r="Object"===r&&e.constructor?e.constructor.name:r)||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?c(e,t
...
i||null==r.return||r.return()}finally{if(a)throw o}}}}function c(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r]
;return n}for(var h=function(){function e(){(0,u.default)(this,e),window.kioskModeEntities={},this.queryString("clear_km_cache")&&this.setCache([
"kmHeader","kmSidebar","kmOverflow"],"false"),this.ha=document.querySelector("home-assistant"),this.main=this.ha.shadowRoot.querySelector(
"home-assistant-main").shadowRoot,this.user=this.ha.hass.user,this.llAttempts=0,this.run(),this.entityWatch(),new MutationObserver(
this.watchDashboards).observe(this.main.querySelector("partial-panel-resolver"),{childList:!0})}var t;return(0,l.default)(e,[{key:"run",
value:function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:this.main.querySelector("ha-panel-lovelace");!this.queryString(
"disable_km")&&e&&this.getConfig(e)}},{key:"getConfig",value:function(t){var r=this;this.llAttempts++;try{var e=t.lovelace.config.kiosk_mode||{}
...
,t){var r=this,n=this.ha.hass.panelUrl;window.kioskModeEntities[n]||(window.kioskModeEntities[n]=[]),
...
)||this.queryString(["kiosk","hide_sidebar","hide_header","hide_overflow"]);o&&(this.hideHeader=this.cached("kmHeader")||this.queryString(["kiosk",
"hide_header"]),this.hideSidebar=this.cached("kmSidebar")||this.queryString(["kiosk","hide_sidebar"]),this.hideOverflow=this.cached("kmOverflow"
)||this.queryString(["kiosk","hide_overflow"])),this.hideHeader=o?this.hideHeader:t.kiosk||t.hide_header,
this.hideSidebar=o?this.hideSidebar:t.kiosk||t.hide_sidebar,this.hideOverflow=o?this.hideOverflow:t.kiosk||t.hide_overflow
;var i=this.user.is_admin?t.admin_settings:t.non_admin_settings;if(i&&this.setOptions(i),t.user_settings){var a,s=f(this.array(t.user_settings));try{
for(s.s();!(a=s.n()).done;){var u=a.value;this.array(u.users).some(function(e){return e.toLowerCase()==r.user.name.toLowerCase()})&&this.setOptions(u)
}}catch(e){s.e(e)}finally{s.f()}}o=this.ignoreMobile?null:t.mobile_settings;o&&(i=o.custom_width||812,window.innerWidth<=i&&this.setOptions(o))
;t=this.ignoreEntity?null:t.entity_settings;if(t){var l,c=f(t);try{for(c.s();!(l=c.n()).done;){var h=l.value,d=Object.keys(h.entity)[0]
;window.kioskModeEntities[n].includes(d)||window.kioskModeEntities[n].push(d),this.ha.hass.states[d].state==h.entity[d]&&("hide_header"in h&&(
this.hideHeader=h.hide_header),"hide_sidebar"in h&&(this.hideSidebar=h.hide_sidebar),"hide_overflow"in h&&(this.hideOverflow=h.hide_overflow),
"kiosk"in h&&(this.hideHeader=this.hideSidebar=h.kiosk))}}catch(e){c.e(e)}finally{c.f()}}this.insertStyles(e)}},{key:"insertStyles",value:function(e){
var t=e.shadowRoot.querySelector("hui-root").shadowRoot,r=this.main.querySelector("app-drawer-layout"),e=t.querySelector("app-toolbar")
...
"cache")&&this.setCache("kmSidebar","true")):this.removeStyle([e,r]),window.dispatchEvent(new Event("resize")),this.llAttempts=0}},{
...
this.ignoreEntity=e.ignore_entity_settings,this.ignoreMobile=e.ignore_mobile_settings}},{key:"array",value:function(e){return Array.isArray(e)?e:[e]}}
,{key:"queryString",value:function(e){return this.array(e).some(function(e){return window.location.search.includes(e)})}},{key:"setCache",
value:function(e,t){this.array(e).forEach(function(e){return window.localStorage.setItem(e,t)})}},{key:"cached",value:function(e){return this.array(e
).some(function(e){return"true"==window.localStorage.getItem(e)})}},{key:"styleExists",value:function(e){return e.querySelector("#kiosk_mode_".concat(
e.localName))}},{key:"addStyle",value:function(e,t){var r;this.styleExists(t)||((r=document.createElement("style")).setAttribute("id",
"kiosk_mode_".concat(t.localName)),r.innerHTML=e,t.appendChild(r))}},{key:"removeStyle",value:function(e){var t=this;this.array(e).forEach(function(e
){t.styleExists(e)&&e.querySelector("#kiosk_mode_".concat(e.localName)).remove()})}}]),e}(),d={header:"%c≡ kiosk-mode".padEnd(27),
ver:"%cversion 1.7.1 "},p=Math.max.apply(Math,(0,a.default)(Object.values(d).map(function(e){return e.length}))),y=0,v=Object.entries(d
);y<v.length;y++){var m=(0,i.default)(v[y],1)[0];d[m].length<=p&&(d[m]=d[m].padEnd(p)),"header"==m&&(d[m]="".concat(d[m].slice(0,-1),"⋮ "))}
...
).then(function(){window.KioskMode=new h})},{"@babel/runtime/helpers/asyncToGenerator":5,"@babel/runtime/helpers/classCallCheck":6,
...
function s(e,t,r,n){var o,i,a,s,t=t&&t.prototype instanceof v?t:v,t=Object.create(t.prototype),n=new E(n||[]);return t._invoke=(o=e,i=r,a=n,s=h,
function(e,t){if(s===f)throw new Error("Generator is already running");if(s===p){if("throw"===e)throw t;return O()}for(a.method=e,a.arg=t;;){
...
return y}var n=c(n,t.iterator,r.arg);if("throw"===n.type)return r.method="throw",r.arg=n.arg,r.delegate=null,y;n=n.arg;if(!n)return r.method="throw",
...
)a.sent=a._sent=a.arg;else if("throw"===a.method){if(s===h)throw s=p,a.arg;a.dispatchException(a.arg)}else"return"===a.method&&a.abrupt("return",a.arg
);s=f;n=c(o,i,a);if("normal"===n.type){if(s=a.done?p:d,n.arg!==y)return{value:n.arg,done:a.done}}else"throw"===n.type&&(s=p,a.method="throw",
a.arg=n.arg)}}),t}function c(e,t,r){try{return{type:"normal",arg:e.call(t,r)}}catch(e){return{type:"throw",arg:e}}}a.wrap=s;var h="suspendedStart",
d="suspendedYield",f="executing",p="completed",y={};function v(){}function m(){}function b(){}var g={};g[n]=function(){return this}
;t=Object.getPrototypeOf,t=t&&t(t(j([])));t&&t!==e&&l.call(t,n)&&(g=t);var w=b.prototype=v.prototype=Object.create(g);function x(e){["next","throw",
"return"].forEach(function(t){i(e,t,function(e){return this._invoke(t,e)})})}function k(a,s){var t;this._invoke=function(r,n){function e(){
return new s(function(e,t){!function t(e,r,n,o){e=c(a[e],a,r);if("throw"!==e.type){var i=e.arg;return(r=i.value)&&"object"==typeof r&&l.call(r,
...
;return e.value=u,e.done=!0,e};return e.next=e}}return{next:O}}function O(){return{value:u,done:!0}}return((m.prototype=w.constructor=b).constructor=m
).displayName=i(b,o,"GeneratorFunction"),a.isGeneratorFunction=function(e){e="function"==typeof e&&e.constructor;return!!e&&(
e===m||"GeneratorFunction"===(e.displayName||e.name))},a.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,b):(e.__proto__=b,i(e,o
,"GeneratorFunction")),e.prototype=Object.create(w),e},a.awrap=function(e){return{__await:e}},x(k.prototype),k.prototype[r]=function(){return this},
a.AsyncIterator=k,a.async=function(e,t,r,n,o){void 0===o&&(o=Promise);var i=new k(s(e,t,r,n),o);return a.isGeneratorFunction(t)?i:i.next().then(
function(e){return e.done?e.value:i.next()})},x(w),i(w,o,"Generator"),w[n]=function(){return this},w.toString=function(){return"[object Generator]"},
a.keys=function(r){var e,n=[];for(e in r)n.push(e);return n.reverse(),function e(){for(;n.length;){var t=n.pop();if(t in r)return e.value=t,e.done=!1,
e}return e.done=!0,e}},a.values=j,E.prototype={constructor:E,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=u,this.done=!1,
this.delegate=null,this.method="next",this.arg=u,this.tryEntries.forEach(S),!e)for(var t in this)"t"===t.charAt(0)&&l.call(this,t)&&!isNaN(+t.slice(1)
)&&(this[t]=u)},stop:function(){this.done=!0;var e=this.tryEntries[0].completion;if("throw"===e.type)throw e.arg;return this.rval},
dispatchException:function(r){if(this.done)throw r;var n=this;function e(e,t){return i.type="throw",i.arg=r,n.next=e,t&&(n.method="next",n.arg=u),!!t}
for(var t=this.tryEntries.length-1;0<=t;--t){var o=this.tryEntries[t],i=o.completion;if("root"===o.tryLoc)return e("end");if(o.tryLoc<=this.prev){
var a=l.call(o,"catchLoc"),s=l.call(o,"finallyLoc");if(a&&s){if(this.prev<o.catchLoc)return e(o.catchLoc,!0);if(this.prev<o.finallyLoc)return e(
...
n.tryLoc<=this.prev&&l.call(n,"finallyLoc")&&this.prev<n.finallyLoc){var o=n;break}}var i=(o=o&&("break"===e||"continue"===e
)&&o.tryLoc<=t&&t<=o.finallyLoc?null:o)?o.completion:{};return i.type=e,i.arg=t,o?(this.method="next",this.next=o.finallyLoc,y):this.complete(i)},
complete:function(e,t){if("throw"===e.type)throw e.arg;return"break"===e.type||"continue"===e.type?this.next=e.arg:"return"===e.type?(
this.rval=this.arg=e.arg,this.method="return",this.next="end"):"normal"===e.type&&t&&(this.next=t),y},finish:function(e){for(
var t=this.tryEntries.length-1;0<=t;--t){var r=this.tryEntries[t];if(r.finallyLoc===e)return this.complete(r.completion,r.afterLoc),S(r),y}},
catch:function(e){for(var t=this.tryEntries.length-1;0<=t;--t){var r=this.tryEntries[t];if(r.tryLoc===e){var n,o=r.completion
;return"throw"===o.type&&(n=o.arg,S(r)),n}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,r){return this.delegate={iterator:j(e
),resultName:t,nextLoc:r},"next"===this.method&&(this.arg=u),y}},a}("object"==typeof t?t.exports:{});try{regeneratorRuntime=t}catch(e){Function("r",
"regeneratorRuntime = r")(t)}},{}]},{},[1]);
